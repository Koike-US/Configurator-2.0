...
namespace Configurator_2._0
{
    class Globals
    {
        ...
        public static DataTable MachineOptComp = new DataTable(); //This contains all of the option compatability data for the currently selected machine, and is the "heart" of the configurator
